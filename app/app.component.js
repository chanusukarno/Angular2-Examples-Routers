System.register(['angular2/core', "angular2/router", "./albums.component", "./contact.component", "./album.component", "./blog.component", "./archives.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, albums_component_1, contact_component_1, album_component_1, blog_component_1, archives_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
                    ...
                    router_1.RouteConfig([
                        {
                            path: '/albums',
                            name: 'Albums',
                            component: albums_component_1.AlbumsComponent, useAsDefault: true
                        },
                        {
                            path: '/albums/:id',
                            name: 'Album',
